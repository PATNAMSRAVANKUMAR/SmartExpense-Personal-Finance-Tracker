  ...
  return (
    <div className="relative flex-1 min-w-[240px]">
      ...
      <input
        ...
        className="block w-full pl-10 pr-9 py-2 rounded-xl text-sm border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 placeholder-slate-400 dark:placeholder-slate-500 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
      />
      {value && (
        <button
          type="button"
